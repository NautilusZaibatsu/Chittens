    ...
    if (this.highlighted || this.selected) {
      ...
      if (this.highlighted) {
        ...
        if (chibis[this.id].albinism) {
          ...
          cString = ntc.name(chibis[this.id].firstColour)[1];
          if (c2 !== cString) {
            cString += ' & '+ c2;
          }
        }
