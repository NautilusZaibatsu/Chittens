...
function breedBengal(who) {
  ...
  who.secondColour = mixTwoColours('#814211', '#646464', cSway);
  who.thirdColour = mixTwoColours('#f6d4b1', '#e4e4e4', cSway);
  who.eyeColour = mixTwoColours('#cbe06b', '#627364', Math.random());
  who.thickness = 0.6;
  who.tailLength = 1;
  who.fangs = 0.75;
  who.eyePosY = 0.65;
